function [T,w,q,y,R]=equivpubliccost(A0,Ai,B0,Bi,C0,Ci,D,x,IC,IP,IY,p1,p2,...
    Top,sop,R_bar,r,weight,ext,qLF,v)
   ...
   xop=log(exp(x)+v.*T);
   [w,y]=Marshallian(A0,Ai,B0,Bi,C0,Ci,D,xop,IC,IP,IY,p1,p2,r);
   q=w.*exp(xop)./exp(p1);
